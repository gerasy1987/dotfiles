...
- **Relative paths**: Quarto's `execute-dir: project` means R paths are relative to project root; verify figure paths resolve correctly, and use sync scripts if deployment directories differ
